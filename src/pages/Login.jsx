...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (isLogin) {
      try {
        const res = await axios.post('https://new-backend-1-jv2p.onrender.com/api/auth/login', {
          email: formData.email,
          password: formData.password
        });
      ...
      try {
        const res = await axios.post('https://new-backend-1-jv2p.onrender.com/api/auth/register', {
          firstName: formData.firstName,
          lastName: formData.lastName,
          email: formData.email,
          password: formData.password
