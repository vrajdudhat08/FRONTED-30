...
//       if (foundUser) {
//         alert(`Welcome back, ${foundUser.firstName || 'User'}!`);
...
//       const alreadyExists = storedUsers.some(user => user.email === formData.email);
//       if (alreadyExists) {
...
const handleRegister = async (e) => {
  ...
  try {
    ...
    console.log(err.response); // Very important for debugging
